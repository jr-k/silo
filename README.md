...
<sub>macOS: <code>arm64</code> for Apple Silicon (M1 and later), <code>x86_64</code> for Intel Macs. Installer or portable zip for Windows x64, AppImage for Linux x86_64. Checksums in <code>SHA256SUMS.txt</code>.</sub>
